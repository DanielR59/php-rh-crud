    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-6">
            ...
            <div class="input-group mb-3">
                <input type="text" name="email-user" class="form-control" placeholder="Username" aria-label="Username"
                    required>
                <span class="input-group-text">@</span>
                <input type="text" name="email-domain" class="form-control" value="bluetab.net" aria-label="Server"
                    readonly>
            </div>
        </div>
        <div class="col-12">
