        ...
        <div class="col-sm-12 col-lg-6">
            <div class="mb-3 ">
                ...
                <input type="text" name="name" class="form-control" id="validationDefaultUsername"
                    aria-describedby="emailHelp" value="<?php echo $name ?>" required>
            </div>
        </div>
        <div class="col-sm-12 col-lg-6">
            <label for="exampleInputEmail1" class="form-label">Correo</label>
            <div class="input-group mb-3">
                <input type="email" name="email-user"  class="form-control" id="Username"
                aria-label="Username" value="<?php echo $email ?>" readonly>
            </div>
        </div>
        <div class="col-12">
